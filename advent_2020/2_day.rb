...
def pass_word_sub_str_verifier
  ...
  file_reader.each_line do |line|
    ...
    first_char = line_arr[2][low - 1]
    second_char = line_arr[2][high - 1]

    valid_passwords += 1 if first_char.eql?(letter) ^ second_char.eql?(letter)
